...
define("_AM_ADMIT_TH0","Usuàrio");
define("_AM_ADMIT_TH1","Hora e data de inicio");
define("_AM_ADMIT_TH2","Hora e data de final");
define("_AM_ADMIT_TH3","Titulo");
...
define("_AM_LABEL_IO_DELETE","para ser(em) excluido(s)");
...
define("_AM_MES_DELETED","evento(s) foi(foram) excluido(s)");
define("_AM_IO_TH0","Usuàrio");
define("_AM_IO_TH1","Hora e data de inicio");
define("_AM_IO_TH2","Hora e data de final");
define("_AM_IO_TH3","Titulo");
...
define( '_AM_GROUPPERMDESC' , "Selecione permissões que cada grupo està autorizado a fazer<br>Se você necessita desta caracteristica, antes selecione 'Atribuições dos usuàrios' para especificar em permissões do Grupo.<br />As opções dos grupos Administrator e Guest serão ignoradas." ) ;
...
define( '_AM_NOTICE_NOERRORS' , "Não hà erro em tabelas ou registros." ) ;
define( '_AM_ALRT_CATTABLENOTEXIST' , "A tabela de categorias nâo existe.<br />\nVocê criou a tabela ?" ) ;
define( '_AM_ALRT_OLDTABLE' , "A estrutura da tabela de eventos à antiga.<br />\nVocê atualizo a tabela ?" ) ;
...
define( '_AM_FMT_WRONGSTZ' , "Hà %s eventos que estão registrados com fuso horàrio errado.<br>Você deseja reparar?" ) ;

// Categories
define( '_AM_CAT_TH_TITLE' , 'Titulo' ) ;
define( '_AM_CAT_TH_DESC' , 'Descrição' ) ;
define( '_AM_CAT_TH_PARENT' , 'Categoria Acima' ) ;
define( '_AM_CAT_TH_OPTIONS' , 'Opções' ) ;
define( '_AM_CAT_TH_LASTMODIFY' , 'Ultima Modificação' ) ;
...
define( '_AM_FMT_CAT_DELETED' , '%s Categorias excluidas' ) ;
